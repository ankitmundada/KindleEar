...
SRC_EMAIL = "aomundada@gmail.com"  #Your gmail account for sending mail to Kindle
DOMAIN = "http://readerfeeder.appspot.com/" #Your domain of app

TIMEZONE = 5  #Default timezone, you can modify it in webpage after deployed
